...
function Contact() {
    ...
    return (
        <div id='contact' className='text-white sm:p-10 p-4 border-2 border-[#21bd8e] rounded-t-[200px] mt-10'>
            <h1 data-aos="fade-right" className='text-2xl md:text-4xl text-white font-bold text-center mt-10 mb-4'>Contact Me</h1>
            <div className='flex flex-col-reverse md:flex-row gap-10 justify-around items-center py-10'>
                ...
                <div>
                    <form ref={formRef} onSubmit={sendEmail} className='flex flex-col gap-2 w-64 p-4 bg-[#197e60] text-sm items-center'>
                        <input
                            className='bg-[#050511] p-2 rounded-lg w-full'
                            type="text"
                            name="from_name"
                            placeholder='Devid'
                            required
                        ...
                        />
                        <input
                            className='bg-[#050511] p-2 rounded-lg w-44 cursor-pointer hover:bg-[#050511d0]'
                            type="submit"
                            value="Send"
                        />
                    </form>
